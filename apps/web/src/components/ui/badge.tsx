  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        brand:
          'border-transparent bg-thaiwatsadu-red text-white shadow-xs hover:bg-thaiwatsadu-darkRed',
        thaiwatsadu:
          'border-transparent bg-thaiwatsadu-red text-white shadow-xs hover:bg-thaiwatsadu-darkRed',
        navy:
          'border-transparent bg-thaiwatsadu-dark text-white shadow-xs hover:bg-thaiwatsadu-dark/90',
        success:
        ...
        info:
          'border-sky-500/20 bg-sky-500/10 text-sky-700 dark:text-sky-400 dark:bg-sky-500/15',
      },
    },
    defaultVariants: {
      variant: 'default',
